    ...
    <div class="my-4 w-full max-w-5xl rounded-2xl border border-neutral-300 bg-white shadow-md dark:border-neutral-700 dark:bg-neutral-900">
        ...
        <div class="flex flex-col gap-2 border-b border-neutral-200 px-4 py-4 dark:border-neutral-800 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            ...
            <div class="flex items-center gap-3">
                <span class="inline-flex items-center rounded-full border border-neutral-200 bg-white px-3 py-1 text-xs font-medium text-neutral-600 shadow-sm dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300">
                    Total
                    <span class="ml-1 rounded-full bg-neutral-50 px-2 py-0.5 text-xs font-semibold text-neutral-50 dark:bg-neutral-100 dark:text-neutral-900">
                        {{ $appointments->total() }}
                    </span>
                </span>
            </div>
            ...
            <div class="w-full overflow-x-auto" style="margin-top: 40px">
                <div class="min-w-full overflow-hidden rounded-xl border border-neutral-300 dark:border-neutral-700">
                    <table class="w-full text-xs sm:text-sm">
                        ...
                        <thead class="bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-300 dark:border-neutral-700">
                            <tr>
                                <th class="whitespace-nowrap border-r border-neutral-200 px-3 py-3 text-left text-[0.7rem] font-semibold uppercase tracking-wide text-neutral-500 dark:border-neutral-700 dark:text-neutral-400">
                                    ID
                                </th>
                                <th class="whitespace-nowrap border-r border-neutral-200 px-3 py-3 text-left text-[0.7rem] font-semibold uppercase tracking-wide text-neutral-500 dark:border-neutral-700 dark:text-neutral-400">
                                    Service
                                ...
                                <th class="hidden whitespace-nowrap border-r border-neutral-200 px-3 py-3 text-left text-[0.7rem] font-semibold uppercase tracking-wide text-neutral-500 dark:border-neutral-700 dark:text-neutral-400 md:table-cell">
                                    Phone
                                </th>
                                <th class="hidden whitespace-nowrap border-r border-neutral-200 px-3 py-3 text-left text-[0.7rem] font-semibold uppercase tracking-wide text-neutral-500 dark:border-neutral-700 dark:text-neutral-400 lg:table-cell">
                                    Date &amp; Time
                                </th>
                                <th class="whitespace-nowrap border-r border-neutral-200 px-3 py-3 text-left text-[0.7rem] font-semibold uppercase tracking-wide text-neutral-500 dark:border-neutral-700 dark:text-neutral-400">
                                    Status
                                ...
                                <th class="whitespace-nowrap px-3 py-3 text-right text-[0.7rem] font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400">
                                    Actions
                                </th>
                            </tr>
                        </thead>
                        ...
                        <tbody class="bg-white dark:bg-neutral-900">
                            @forelse($appointments as $appointment)
                                <tr class="border-t border-neutral-200 hover:bg-neutral-50 dark:border-neutral-800 dark:hover:bg-neutral-900/70">
                                    {{-- ID --}}
                                    <td class="whitespace-nowrap border-r border-neutral-200 px-3 py-3 text-[0.75rem] font-medium text-neutral-600 dark:border-neutral-800 dark:text-neutral-300">
                                        #{{ $appointment->id }}
                                    </td>
                                    ...
                                    {{-- Created --}}
                                    <td class="hidden border-r border-neutral-200 px-3 py-3 text-[0.7rem] text-neutral-500 dark:border-neutral-800 dark:text-neutral-400 md:table-cell">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-3 text-right">
                                        <div class="inline-flex items-center gap-2">
                                            <a href="{{ route('back.appointments.show', $appointment->id) }}"
                                               class="inline-flex items-center rounded-full border border-blue-200 px-3 py-1.5 text-[0.72rem] font-medium text-blue-700 transition hover:bg-blue-50 dark:border-blue-700/60 dark:text-blue-200 dark:hover:bg-blue-900/40">
                                                View
                                            </a>
                                            ...
                                            <form action="{{ route('back.appointments.destroy', $appointment->id) }}"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                        class="inline-flex items-center rounded-full border border-rose-200 px-3 py-1.5 text-[0.72rem] font-medium text-rose-700 transition hover:bg-rose-50 dark:border-rose-700/60 dark:text-rose-200 dark:hover:bg-rose-900/40">
                                                    Delete
                                                </button>
                                            </form>
                                        </div>
