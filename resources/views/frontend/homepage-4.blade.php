...
<body class="dark-scheme">
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
                      ...
                      <div class="col-lg-6">
                            <div class="pt-lg-5 mt-lg-5 me-lg-3">
                                <div class="py-5 mt-5 mb-3 me-lg-3">
                                    <div class="subtitle id-color wow fadeInUp" data-wow-delay=".0s">Welcome to AutoDetail</div>
                                    <h1 class="wow fadeInUp" data-wow-delay=".2s">Reviving Rides With Skill And Shine</h1>
                                    <p class="col-lg-10 wow fadeInUp" data-wow-delay=".4s">We provide expert car detailing for every vehicle. From deep interior cleaning to high-end exterior protection, our team ensures your car looks flawless, inside and out.</p>

                                    <a class="btn-main mb10 mb-3 wow fadeInUp" data-wow-delay=".6s" href="contact.html"><span>Book Detailing</span></a>
            ...
            <section>
                <div class="container">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <a href="service-single.html" class="bg-dark-2 d-block hover overflow-hidden rounded-1">
                                <div class="row g-0 align-items-center">
                                    <div class="col-sm-6">
                                        <div class="p-40">
                                            <h3>Exterior Hand Wash & Wax</h3>
                                            <p class="mb-0">Gentle hand washing and premium wax application for a glossy, protective finish that brings your car's exterior to life.</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="relative overflow-hidden">
                                            <h3 class="abs text-white fs-32 lh-1 p-4 top-0 start-0 z-3">01</h3>
                                            <div class="sw-overlay z-2 op-5"></div>
                                ...
                                <div class="row g-0 align-items-center">
                                    <div class="col-sm-6">
                                        <div class="p-40">
                                            ...
                                            <p class="mb-0">Thorough vacuuming, shampooing, and sanitizing to remove dirt, stains, and odors from seats, carpets, and upholstery.</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="relative overflow-hidden">
                                ...
                                <div class="row g-0 align-items-center">
                                    <div class="col-sm-6">
                                        <div class="p-40">
                                            ...
                                            <p class="mb-0">Eliminates swirls, oxidation, and light scratches for a flawless finish and like-new paint clarity.</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="relative overflow-hidden">
                                            <h3 class="abs text-white fs-32 lh-1 p-4 top-0 start-0 z-3">03</h3>
                                            <div class="sw-overlay z-2 op-5"></div>
                                ...
                                <div class="row g-0 align-items-center">
                                    <div class="col-sm-6">
                                        <div class="p-40">
                                            ...
                                            <p class="mb-0">Advanced ceramic protection to shield your paint from the elements while enhancing shine and hydrophobic properties.</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="relative overflow-hidden">
                                            <h3 class="abs text-white fs-32 lh-1 p-4 top-0 start-0 z-3">04</h3>
                                            <div class="sw-overlay z-2 op-5"></div>
                                            <img src="images/services/4.webp" class="w-100 hover-scale-1-2" alt="">
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="row g-0 align-items-center">
                                    <div class="col-sm-6">
                                        <div class="p-40">
                                            ...
                                            <p class="mb-0">Careful degreasing and cleaning of your engine bay to restore appearance and prevent dirt buildup or corrosion.</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="relative overflow-hidden">
                                            <h3 class="abs text-white fs-32 lh-1 p-4 top-0 start-0 z-3">05</h3>
                                            <div class="sw-overlay z-2 op-5"></div>
                                            <img src="images/services/5.webp" class="w-100 hover-scale-1-2" alt="">
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="row g-0 align-items-center">
                                    <div class="col-sm-6">
                                        <div class="p-40">
                                            ...
                                            <p class="mb-0">Restores clarity and improves visibility by removing haze, oxidation, and yellowing from headlight lenses.</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="relative overflow-hidden">
                                            <h3 class="abs text-white fs-32 lh-1 p-4 top-0 start-0 z-3">06</h3>
                                            <div class="sw-overlay z-2 op-5"></div>
                                            <img src="images/services/6.webp" class="w-100 hover-scale-1-2" alt="">
                                        </div>
                                    </div>
                                </div>
                            </a>
            ...
            <section class="pt-0" aria-label="section">
                ...
                <div class="container relative z-1">
                    <div class="row g-4 gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="wow fadeInUp" data-wow-delay=".6s">At ShinePro, we’re passionate about making every vehicle look its absolute best—inside and out. From restoring showroom-level gloss to deep-cleaning interiors, our expert team delivers flawless results with care and precision.</p>
            ...
            <section>
                <div class="container">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="owl-carousel owl-theme owl-2-dots wow fadeInUp">

                                    <!-- Testimonial 1 -->
                                    <div class="item">
                                        <div class="bg-dark-2 rounded-1 p-30">
                ...
                <div class="container relative z-2">
                    <div class="row g-4">
                        <div class="col-lg-8 offset-lg-2 mb-4 text-center">
                            ...
                            <h2 class="wow fadeInUp">@autodetail_works</h2>
                        </div>
                    </div>
                </div>
