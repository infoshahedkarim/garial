                        ...
                        <div class="row g-4 justify-content-between align-items-bottom">
                            ...
                            <div class="col-lg-3">
                                ...
                                <p class="mb-0 wow fadeInUp" data-wow-delay=".2s">
                                    গাড়িয়ালে, আমরা ব্যক্তিগত গাড়ি এবং ব্যবহারের জন্য নির্ভরযোগ্য, দক্ষ বিবরণ সরবরাহ করি,
                                    শোরুমের উজ্জ্বলতা পুনরুদ্ধার করি, গাড়ির আয়ু বৃদ্ধি করি এবং আপনার বিনিয়োগ রক্ষা করি।
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-4 gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s">
                            ShinePro-তে, আমরা প্রতিটি গাড়িকে ভেতরের এবং বাইরের দিক থেকে সর্বোত্তম করে তুলতে আগ্রহী।
                            শোরুম-স্তরের গ্লস পুনরুদ্ধার থেকে শুরু করে অভ্যন্তরীণ অংশ গভীরভাবে পরিষ্কার করা পর্যন্ত, আমাদের
                            বিশেষজ্ঞ দল যত্ন এবং নির্ভুলতার সাথে ত্রুটিহীন ফলাফল প্রদান করে।
                        </p>
