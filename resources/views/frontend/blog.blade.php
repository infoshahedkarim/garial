                ...
                <div class="container relative z-2">
                    <div class="row gy-4 gx-5 justify-content-center">
                        <div class="col-lg-12 text-center">
                            ...
                            <h1 class="mb-3 wow fadeInUp" data-wow-delay=".2s">Blog</h1>
                ...
                <div class="row g-4">
                  ...
                  <div class="col-lg-4">
                    <div class="rounded-1 overflow-hidden">
                      <div class="relative">
                        <img src="images/blog/1.webp" class="w-100" alt="">
                      </div>
                      <div class="bg-dark-2 p-30">
                        <div class="de-flex">
                          <div class="bg-color text-white p-3 pb-2 mt-min-1 me-4 text-center fw-600 rounded-1">
                            <h4 class="fs-36 mb-0 lh-1">20</h4>
                            <span>Jun</span>
                          </div>
                          <a href="blog-single.html">
                            <h4 class="mb-0">Ceramic Coating Benefits: What Every Car Owner Should Know</h4>
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="rounded-1 overflow-hidden">
                      <div class="relative">
                        <img src="images/blog/2.webp" class="w-100" alt="">
                      </div>
                      <div class="bg-dark-2 p-30">
                        <div class="de-flex">
                          <div class="bg-color text-white p-3 pb-2 mt-min-1 me-4 text-center fw-600 rounded-1">
                          ...
                          <a href="blog-single.html">
                            <h4 class="mb-0">5 Detailing Mistakes That Could Damage Your Car's Appearance</h4>
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="rounded-1 overflow-hidden">
                      <div class="relative">
                        <img src="images/blog/3.webp" class="w-100" alt="">
                      </div>
                      <div class="bg-dark-2 p-30">
                        <div class="de-flex">
                          <div class="bg-color text-white p-3 pb-2 mt-min-1 me-4 text-center fw-600 rounded-1">
                          ...
                          <a href="blog-single.html">
                            <h4 class="mb-0">How to Protect Car Paint Against Sun, Dirt, Rain and Dust</h4>
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="rounded-1 overflow-hidden">
                      <div class="relative">
                        <img src="images/blog/4.webp" class="w-100" alt="">
                      </div>
                      <div class="bg-dark-2 p-30">
                        <div class="de-flex">
                          <div class="bg-color text-white p-3 pb-2 mt-min-1 me-4 text-center fw-600 rounded-1">
                          ...
                          <a href="blog-single.html">
                            <h4 class="mb-0">Engine Bay Detailing: Improve Performance and Impress Buyers</h4>
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="rounded-1 overflow-hidden">
                      <div class="relative">
                        <img src="images/blog/5.webp" class="w-100" alt="">
                      </div>
                      <div class="bg-dark-2 p-30">
                        <div class="de-flex">
                          <div class="bg-color text-white p-3 me-4 text-center fw-600">
                            <h4 class="fs-36 mb-0 lh-1">16</h4>
                            <span>Jun</span>
                          </div>
                          <a href="blog-single.html">
                            <h4 class="mb-0">Car Detailing Through the Years: How Techniques Have Evolved</h4>
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="rounded-1 overflow-hidden">
                      <div class="relative">
                        <img src="images/blog/6.webp" class="w-100" alt="">
                      </div>
                      <div class="bg-dark-2 p-30">
                        <div class="de-flex">
                          <div class="bg-color text-white p-3 pb-2 mt-min-1 me-4 text-center fw-600 rounded-1">
                          ...
                          <a href="blog-single.html">
                            <h4 class="mb-0">Interior Detailing Tips to Refresh Seats, Dash, and More Fast</h4>
                          </a>
                        </div>
                      </div>
                    </div>
