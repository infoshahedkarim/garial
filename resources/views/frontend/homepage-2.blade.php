                ...
                <div class="container relative z-3">
                    ...
                    <div class="row g-4 justify-content-center">
                        <div class="col-lg-8 text-center">
                            ...
                            <p class="mb-0 col-lg-6 offset-lg-3 wow fadeInUp" data-wow-delay=".2s">AutoDetail offers efficient, reliable detailing that restores shine and preserves your vehicle.</p>
                            <div class="spacer-single"></div>
                            <a class="btn-main fx-slide" href="#"><span>Make Appointment</span></a>
                        </div>

                        <div class="spacer-single"></div>

                        <div class="col-lg-12">
                            <img src="images/misc/c2.webp" class="w-100" alt="">
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6">
                            <div class="hover rounded-1 overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".0s">
                                <img src="images/services-2/1.webp" class="hover-scale-1-1 w-100" alt="">
                                <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                                </div>
                                <h3 class="abs fs-32 lh-1 p-4 top-0 start-0 z-2">01</h3>
                        ...
                        <div class="col-sm-6">
                            <div class="hover rounded-1 overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".2s">
                                <img src="images/services-2/2.webp" class="hover-scale-1-1 w-100" alt="">
                                <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                                </div>
                                <h3 class="abs fs-32 lh-1 p-4 top-0 start-0 z-2">02</h3>
                                <div class="abs bg-blur z-2 top-0 w-100 h-100 hover-op-1"></div>
                                <div class="sw-overlay op-8"></div>
                                <div class="abs z-2 abs-middle mt-2 w-100 text-center hover-op-0">
                        ...
                        <div class="col-sm-6">
                            <div class="hover rounded-1 overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".4s">
                                <img src="images/services-2/3.webp" class="hover-scale-1-1 w-100" alt="">
                                <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                                </div>
                                <h3 class="abs fs-32 lh-1 p-4 top-0 start-0 z-2">03</h3>
                                <div class="abs bg-blur z-2 top-0 w-100 h-100 hover-op-1"></div>
                                <div class="sw-overlay op-8"></div>
                                <div class="abs z-2 abs-middle mt-2 w-100 text-center hover-op-0">
                        ...
                        <div class="col-sm-6">
                            <div class="hover rounded-1 overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".6s">
                                <img src="images/services-2/4.webp" class="hover-scale-1-1 w-100" alt="">
                                <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                                </div>
                                <h3 class="abs fs-32 lh-1 p-4 top-0 start-0 z-2">04</h3>
                                <div class="abs bg-blur z-2 top-0 w-100 h-100 hover-op-1"></div>
                                <div class="sw-overlay op-8"></div>
                                <div class="abs z-2 abs-middle mt-2 w-100 text-center hover-op-0">
                        ...
                        <div class="col-sm-6">
                            <div class="hover rounded-1 overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".8s">
                                <img src="images/services-2/5.webp" class="hover-scale-1-1 w-100" alt="">
                                <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                                </div>
                                <h3 class="abs fs-32 lh-1 p-4 top-0 start-0 z-2">05</h3>
                                <div class="abs bg-blur z-2 top-0 w-100 h-100 hover-op-1"></div>
                                <div class="sw-overlay op-8"></div>
                                <div class="abs z-2 abs-middle mt-2 w-100 text-center hover-op-0">
                        ...
                        <div class="col-sm-6">
                            <div class="hover rounded-1 overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay="1.0s">
                                <img src="images/services-2/6.webp" class="hover-scale-1-1 w-100" alt="">
                                <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                    <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                                </div>
                                <h3 class="abs fs-32 lh-1 p-4 top-0 start-0 z-2">06</h3>
                                <div class="abs bg-blur z-2 top-0 w-100 h-100 hover-op-1"></div>
                                <div class="sw-overlay op-8"></div>
                                <div class="abs z-2 abs-middle mt-2 w-100 text-center hover-op-0">
