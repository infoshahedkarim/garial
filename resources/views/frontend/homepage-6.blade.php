...
<body class="dark-scheme">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex justify-content-between xs-hide">
                                <div class="d-flex">
                                    <div class="topbar-widget"><a href="#"><img src="images/svg-white/bell.svg" class="" alt="">GetGet 50% Discount for AutoDetail New Member</a></div>
                        ...
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col header-col-mid">
                                ...
                                <ul id="mainmenu">
                                    ...
                                    <li><a class="menu-item" href="shop.html">Shop</a></li>
                                    <li><a class="menu-item" href="#">Gallery</a>
                                        <ul>
                                    ...
                                    <li><a class="menu-item" href="#">Workshop</a>
                                        <ul>
                            ...
                            <div class="de-flex-col">
                                <div class="menu_side_area">
                                    <a href="appointment.html" class="btn-main fx-slide hover-white"><span>Make Appointment</span></a>
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section class="relative overflow-hidden jarallax">
                ...
                <div class="container relative z-2">
                    <div class="row g-4 gx-5 align-items-center justify-content-between">
                        <div class="col-lg-6">
                            <h1 class="wow fadeInUp" data-wow-delay=".2s">Restore Shine, Protect Value, Drive with Confidence.</h1>
                        </div>
                        <div class="col-lg-6">
                            <p class="wow fadeInUp" data-wow-delay=".4s">We specialize in premium auto detailing that rejuvenates your vehicle inside and out. Our process combines expert care with advanced cleaning technology, ensuring your car regains its showroom brilliance, long-lasting protection, and a flawless finish that turns every drive into pride.</p>
                            <a href="appointment.html" class="btn-main btn-line fx-slide wow fadeInUp" data-wow-delay=".8s"><span>Make Appointment</span></a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="relative overflow-hidden">
                                <div class="owl-custom-nav menu-float" data-target="#carousel-6">
                                    <a class="btn-next"></a>
                                    <a class="btn-prev"></a>                                
                                    <div id="carousel-6" class="owl-single owl-carousel owl-theme">
                                        <!-- item begin -->
                                        <div class="item">
                                            <div class="relative">
                                                <div class="overflow-hidden">
                                                    <img src="images/slider-wide/1.webp" class="w-100" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- item end -->
                                        ...
                                        <div class="item">
                                            <div class="relative">
                                                <div class="overflow-hidden">
                                                    <img src="images/slider-wide/2.webp" class="w-100" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- item end -->
                                        ...
                                        <div class="item">
                                            <div class="relative">
                                                <div class="overflow-hidden">
                                                    <img src="images/slider-wide/3.webp" class="w-100" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- item end -->
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12 wow fadeInUp">
                            <div class="owl-6 no-alpha owl-carousel owl-theme">
                                <img src="images/logo-brands/1.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/2.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/3.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/4.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/5.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/6.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/7.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/8.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/9.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/10.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/11.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/12.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/13.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/14.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/15.webp" class="w-100 px-lg-5 p-4" alt="">
                                <img src="images/logo-brands/16.webp" class="w-100 px-lg-5 p-4" alt="">
            ...
            <section class="no-top">
                <div class="container relative z-1">
                    <div class="row g-4 align-items-center justify-content-between">
                        ...
                        <div class="col-lg-6">
                            <p class="mb-0">From deep interior cleaning to long-lasting ceramic coating, we restore and protect your vehicle with precision, care, and a commitment to perfection.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container-fluid">
                    <div class="row g-0">
                        <div class="col-lg-3 col-md-6 wow fadeInRight" data-wow-delay=".0s">
                            <div class="bg-color-op-7 p-40 h-100">
                                <div class="relative">
                                    <h4>Expert Technicians</h4>
                                    <p class="mb-0">Our detailers are skilled professionals with years of experience in car care.</p>
                                </div>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-6 wow fadeInRight" data-wow-delay=".2s">
                            <div class="bg-color-op-8 p-40 h-100">
                                <div class="relative">
                                    <h4>Tailored Packages</h4>
                                    <p class="mb-0">Detailing options customized to your car’s condition and your preferences.</p>
                                </div>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-6 wow fadeInRight" data-wow-delay=".4s">
                            <div class="bg-color-op-9 p-40 h-100">
                                <div class="relative">
                                    <h4>Affordable Pricing</h4>
                                    <p class="mb-0">Competitive rates with no hidden fees — quality service that fits your budget.</p>
                                </div>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-6 wow fadeInRight" data-wow-delay=".6s">
                            <div class="bg-color p-40 h-100">
                                <div class="relative">
                                    <h4>Aftercare Support</h4>
                                    <p class="mb-0">We provide post-service tips and care advice to keep your car looking sharp.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section>
                <div class="container relative z-1">
                    <div class="row g-4 align-items-center justify-content-between">
                        <div class="col-lg-6">
                            <div class="subtitle id-color">Our Services</div>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="hover overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".0s">
                        ...
                        <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                            <div class="mb-3">Gentle yet thorough hand wash using pH-balanced soaps, followed by premium wax to protect your paint and enhance shine. Keeps your car sparkling and protected from the elements.</div>
                        ...
                        <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                            <h4 class="mb-3">Exterior Hand Wash & Wax</h4>
                        </div>
                        <div class="gradient-edge-bottom color abs w-100 h-80 bottom-0 op-8"></div>
                    </div>
                </div>
                <!-- service item end -->
                ...
                <!-- service item begin -->
                <div class="col-lg-4 col-sm-6">
                    <div class="hover overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".2s">
                        <img src="images/services/2.webp" class="hover-scale-1-1 w-100" alt="">
                        <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                            <div class="mb-3">From carpets to headliners, we extract every trace of dirt and odor. Our steam and shampoo treatment leaves your cabin fresh, sanitized, and looking like new inside.</div>
                            <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                        </div>
                ...
                <!-- service item begin -->
                <div class="col-lg-4 col-sm-6">
                    <div class="hover overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".4s">
                        <img src="images/services/3.webp" class="hover-scale-1-1 w-100" alt="">
                        <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                            <div class="mb-3">Buff away swirl marks, scratches, and dullness. We restore clarity and depth with multi-stage machine polishing that revives your paint’s original brilliance.</div>
                            <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                        </div>
                        <h3 class="abs fs-32 lh-1 p-4 top-0 start-0">03</h3>
                        <div class="abs bg-blur z-2 top-0 w-100 h-100 hover-op-1"></div>
                        <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                            <h4 class="mb-3">Paint Correction</h4>
                        </div>
                        <div class="gradient-edge-bottom color abs w-100 h-80 bottom-0 op-8"></div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="hover overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".6s">
                        ...
                        <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                            <div class="mb-3">Add years of protection with hydrophobic ceramic coating. Shields against UV rays, dirt, and scratches—making your car easier to clean and stay glossy longer.</div>
                            <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                        </div>
                ...
                <!-- service item begin -->
                <div class="col-lg-4 col-sm-6">
                    <div class="hover overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay=".8s">
                        <img src="images/services/5.webp" class="hover-scale-1-1 w-100" alt="">
                        <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                            <div class="mb-3">We degrease and shine your engine bay for a professional finish. It’s not just for aesthetics—engine cleaning helps with resale and easier maintenance checks.</div>
                            <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                        </div>
                        <h3 class="abs fs-32 lh-1 p-4 top-0 start-0">05</h3>
                        <div class="abs bg-blur z-2 top-0 w-100 h-100 hover-op-1"></div>
                        <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                            <h4 class="mb-3">Engine Bay Detailing</h4>
                        </div>
                        <div class="gradient-edge-bottom color abs w-100 h-80 bottom-0 op-8"></div>
                    </div>
                </div>
                ...
                <!-- service item begin -->
                <div class="col-lg-4 col-sm-6">
                    <div class="hover overflow-hidden relative text-light text-center wow fadeInRight" data-wow-delay="1.0s">
                        <img src="images/services/6.webp" class="hover-scale-1-1 w-100" alt="">
                        <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                            <div class="mb-3">Cloudy headlights are unsafe and ugly. We sand, polish, and seal them so they shine bright and clear again, improving visibility and your car’s overall look.</div>
                            <a class="btn-main fx-slide" href="service-single.html"><span>View Details</span></a>
                        </div>
                        <h3 class="abs fs-32 lh-1 p-4 top-0 start-0">06</h3>
                        <div class="abs bg-blur z-2 top-0 w-100 h-100 hover-op-1"></div>
                        <div class="abs z-2 bottom-0 mb-3 w-100 text-center hover-op-0">
                            <h4 class="mb-3">Headlight Restoration</h4>
                        </div>
                        <div class="gradient-edge-bottom color abs w-100 h-80 bottom-0 op-8"></div>
                    </div>
                </div>
                                ...
                                <div class="owl-carousel owl-theme owl-3-dots wow fadeInUp">
                                    ...
                                    <div class="item">
                                        <div class="relative px-4">
                                            ...
                                            <div class="de-rating-ext mb-2">
                                                <span class="d-stars"><i class="fa fa-star"></i><i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
                                                </span>
                                                <span class="ms-2 text-white">5.0</span>
                                            </div>
                    ...
                    <div class="row g-4">
                      ...
                      <div class="col-lg-4 col-sm-6">
                        <div class="hover">
                          <div class="relative overflow-hidden">
                          <div class="relative overflow-hidden">
                            <img src="images/locations/s1.webp" class="w-100 hover-scale-1-2 rounded-1" alt="">
                          </div>
                      ...
                      <div class="col-lg-4 col-sm-6">
                        <div class="hover">
                          <div class="relative overflow-hidden">
                          <div class="relative overflow-hidden">
                            <img src="images/locations/s2.webp" class="w-100 hover-scale-1-2 rounded-1" alt="">
                          </div>
                            <div class="p-30 relative bg-dark-2 mx-4 mt-min-100 rounded-1">
                              <h4>AutoDetail East</h4>
                      ...
                      <div class="col-lg-4 col-sm-6">
                        <div class="hover">
                          <div class="relative overflow-hidden">
                          <div class="relative overflow-hidden">
                            <img src="images/locations/s3.webp" class="w-100 hover-scale-1-2 rounded-1" alt="">
                          </div>
                            <div class="p-30 relative bg-dark-2 mx-4 mt-min-100 rounded-1">
                              <h4>AutoDetail North</h4>
            ...
            <section class="bg-dark-2 p-0 relative no-bottom">
                <div class="container-fluid">
                    <div class="row g-0">
                        <div class="col-md-6">
                            <div class="row g-0">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <div class="de-flex">
                    <div class="de-flex-col">
                      &copy; 2025 - AutoDetail by Designesia
                    </div>
    ...
    <div id="extra-wrap" class="text-light">
        ...
        <div id="extra-content">
            ...
            <div><i class="icofont-location-pin me-2 op-5"></i>123 Shine Street, Los Angeles, CA </div>
            <div><i class="icofont-envelope me-2 op-5"></i>support@autodetail.com</div>
