...
<body class="dark-scheme">
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section class="pt-120 sm-pt-0 pb-0">
                <div class="container-fluid">
                    <div class="row g-0">

                        <div class="col-lg-6">
                            <a href="service-single.html" class="bg-dark-2 d-block hover overflow-hidden">
                        ...
                        <div class="col-lg-6">
                            <a href="service-single.html" class="bg-color d-block hover overflow-hidden">
                                <div class="row g-0 align-items-center">
                                    <div class="col-sm-6">
                                        <div class="relative overflow-hidden">
