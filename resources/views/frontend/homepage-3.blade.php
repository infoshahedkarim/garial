...
<body class="dark-scheme">
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section class="section-dark p-0 text-light jarallax relative v-center" data-video-src="mp4:video/1.mp4">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="text-center">
                                    <h1 class="fs-150 text-uppercase fs-sm-10vw mb-2 lh-1 wow fadeInUp">Luxury Detail</h1>

                                    <p class="mb-0 col-lg-4 offset-lg-4 wow fadeInUp" data-wow-delay=".2s">AutoDetail offers efficient, reliable detailing that restores shine and preserves your vehicle.</p>
                                    <div class="spacer-single"></div>
                                    <a class="btn-main btn-line fx-slide wow fadeInUp" data-wow-delay=".4s" href="#"><span>Make Appointment</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
