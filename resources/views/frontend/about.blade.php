        ...
        <div class="no-bottom no-top" id="content">
                ...
                <div class="container relative z-2">
                    <div class="row gy-4 gx-5 justify-content-center">
                        <div class="col-lg-12 text-center">
                            ...
                            <h1 class="mb-3 wow fadeInUp" data-wow-delay=".2s">About Us</h1>
                ...
                <div class="container">
                    <div class="row gy-4 gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay=".2s">Car Detailing for Long-Lasting Protection</h2>
                            <p>At AutoDetail, we are passionate about restoring and preserving vehicles through expert detailing services. Since our beginning, we’ve committed ourselves to high-quality craftsmanship, using premium products and proven techniques to make cars look and feel like new again.</p>

                            <p>We believe car care should be simple and satisfying. That’s why we offer full-service detailing, from exterior hand washing to ceramic coating, all tailored to your car’s specific needs. With a focus on detail, trust, and long-term care, AutoDetail is your reliable partner in keeping your car at its best—inside and out.</p>
                        </div>
                    </div>
                </div>
            ...
            <section class="bg-dark-2">
                <div class="container">
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <div class="bg-dark relative rounded-1 overflow-hidden">
                                <img src="images/team/1.webp" class="w-100" alt="">
                                <div class="p-3 text-center">
                                    <h4 class="mb-0">Thomas Bennett</h4>
                                    <p class="mb-2">Lead Detail Specialist</p>
                                    <div class="social-icons">
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-facebook-f"></i></a>
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-x-twitter"></i></a>
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-instagram"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="bg-dark relative rounded-1 overflow-hidden">
                                <img src="images/team/2.webp" class="w-100" alt="">
                                <div class="p-3 text-center">
                                    <h4 class="mb-0">Hailey Cooper</h4>
                                    <p class="mb-2">Customer Care Manager</p>
                                    <div class="social-icons">
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-facebook-f"></i></a>
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-x-twitter"></i></a>
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-instagram"></i></a>
                        ...
                        <div class="col-lg-3">
                            <div class="bg-dark relative rounded-1 overflow-hidden">
                                <img src="images/team/3.webp" class="w-100" alt="">
                                <div class="p-3 text-center">
                                    <h4 class="mb-0">Joshua Henry</h4>
                                    <p class="mb-2">Paint Correction Expert</p>
                                    <div class="social-icons">
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-facebook-f"></i></a>
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-x-twitter"></i></a>
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-instagram"></i></a>
                        ...
                        <div class="col-lg-3">
                            <div class="bg-dark relative rounded-1 overflow-hidden">
                                <img src="images/team/4.webp" class="w-100" alt="">
                                <div class="p-3 text-center">
                                    <h4 class="mb-0">Jackson Reed</h4>
                                    <p class="mb-2">Ceramic Coating Technician</p>
                                    <div class="social-icons">
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-facebook-f"></i></a>
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-x-twitter"></i></a>
                                        <a href="#"><i class="bg-hover-2 text-hover-white fa-brands fa-instagram"></i></a>
                        ...
                        <div class="col-lg-6">
                            ...
                            <ol class="ol-style-1">
                                <li class="wow fadeInUp" data-wow-delay=".2s">
                                    <span class="fw-bold text-white">Premium Car Care:</span> To offer professional detailing solutions that restore, maintain, and protect your vehicle to the highest standard.
                                </li>
                                <li class="wow fadeInUp" data-wow-delay=".4s">
                                    <span class="fw-bold text-white">Sustainable Practices:</span> We emphasize eco-friendly products and water-conscious methods to promote responsible vehicle maintenance.
                                </li>
                                <li class="wow fadeInUp" data-wow-delay=".6s">
                                    <span class="fw-bold text-white">Customer Excellence:</span> We strive to exceed expectations with every detail, delivering reliable service and transparent communication.
                                </li>
                            </ol>
                        </div>
                    </div>
